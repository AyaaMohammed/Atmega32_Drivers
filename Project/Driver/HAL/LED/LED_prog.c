...
ES_t LED_enuInit(LED_t * Copy_pstrLedConfig){
	...
	if(Copy_pstrLedConfig != NULL)
	{
		...
		{
			Local_enuErrorState = DIO_enuSetPinDirection(Copy_pstrLedConfig[Local_enuIterator].LED_u8PortID, DIO_u8OUTPUT  , Copy_pstrLedConfig[Local_enuIterator].LED_u8PinID);
